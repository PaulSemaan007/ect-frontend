          ...
          <Container size="md">
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-gray-300">
                By engaging ECT Security services, you agree to these terms and conditions.
                All security services are provided subject to availability and proper licensing requirements.
              </p>

              <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">Cancellation Policy</h2>
              <p className="text-gray-300">
                Cancellations must be made at least 48 hours in advance. Late cancellations may incur fees.
              </p>

              <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">Liability</h2>
              <p className="text-gray-300">
                ECT Security maintains appropriate liability insurance as required by California law.
                Our guards are trained professionals acting within their scope of authority.
              </p>
