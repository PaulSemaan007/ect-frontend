          ...
          <Container size="md">
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              ...
              <p className="text-gray-300">
                ECT Security collects information you provide when requesting quotes, applying for positions,
                or contacting us. This may include name, email, phone number, and event details.
              </p>
              ...
              <p className="text-gray-300">
                ...
                and do not sell or share your data with third parties except as necessary to provide our services.
              </p>
