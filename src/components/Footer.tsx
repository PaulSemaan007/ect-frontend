    ...
    <footer className="bg-gray-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <p className="text-gray-300">
                <a href={`mailto:${siteConfig.contact.email}`} className="hover:text-neon transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {siteConfig.nav.services.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
          ...
          {/* Service Areas */}
          <div>
            <h3 className="text-foreground font-semibold mb-4">Service Areas</h3>
            <ul className="space-y-2">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} ECT Security. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
